...
const Team = () => {
  ...
  return (
    <>
      <SEO 
        title="Екип - Шампионски Треньори"
        description="Запознайте се с нашите елитни треньори: Дориан Дерменджиев - Вицеевропейски и 8-кратен национален шампион по ММА, Майстор на спорта (2015), Заслужил треньор (2021). Тенчо Караенев - 2-кратен Световен вицешампион и 2-кратен Европейски бронзов медалист, Спортист на годината (2015). Йордан Кукушев - 40 години в спорта, 20 години треньорски опит."
        ...
        structuredData={[
          ...
          getPersonSchema(
            'Йордан Кукушев',
            'Треньор по Борба, Джудо, Бокс и Тай Бокс',
