        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <Card className="mt-12 bg-primary/10 border-primary/30">
            ...
            <CardContent className="space-y-2 text-muted-foreground">
              ...
              <p>• Графикът може да бъде променян при officiални празници или специални събития</p>
              <p className="text-primary font-semibold">• Извън часовете на груповите занимания всички сектори на залата са достъпни за членове на спортния център!</p>
            </CardContent>
          </Card>
        </div>
      </div>
