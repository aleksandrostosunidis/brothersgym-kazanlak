...
const faqCategories = [
    ...
    questions: [
      {
        ...
        a: "Месечен абонамент за ММА е 80 лв (до 18 год) и 90 лв (над 18 год). Комбинирано ММА + Фитнес е 95 лв (до 18 год) и 110 лв (над 18 год). Фитнес: 12 посещения - 50 лв, 16 посещения - 55 лв, Безлимитна - 60 лв, Ученическа карта - 50 лв. VIP персонални тренировки - 15 лв."
      },
      {
        q: "Предлагате ли еднократни тренировки?",
        a: "Да, еднократна тренировка за фитнес е 7 лв. За ММА еднократна тренировка е 10 лв (до 18 год) и 12 лв (над 18 год)."
      },
      {
      ...
      },
      {
        ...
        a: "Не, приемаме само кеш плащания."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    questions: [
      {
        q: "Къде се намирате?",
        a: "Намираме се на ул. Искра 12 (до Club Noir), Казанлък, България."
      },
      {
